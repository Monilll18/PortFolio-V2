      ...
      >
        <Suspense fallback={null}>
          ...
          <Physics gravity={gravity} timeStep={isMobile ? 1 / 30 : 1 / 60}>
            <Band isMobile={isMobile} onHover={onHover} />
          </Physics>
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, onHover }: BandProps) {
      ...
      <group position={[3, 4, 0]}>
        ...
        >
          ...
          <group
            scale={2.25}
            position={[0, -1.2, -0.05]}
            onPointerOver={() => { hover(true); if (onHover) onHover(true); }}
            onPointerOut={() => { hover(false); if (onHover) onHover(false); }}
            onPointerUp={(e: any) => {

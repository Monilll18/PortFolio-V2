...
export function SmoothCursor({
  ...
  // Blue tail follows with looser spring
  const tailX = useSpring(0, { ...springConfig, damping: 60, stiffness: 200 })
  const tailY = useSpring(0, { ...springConfig, damping: 60, stiffness: 200 })
  ...
  useEffect(() => {
    ...
    const smoothPointerMove = (e: PointerEvent) => {
      ...
      tailX.set(currentPos.x)
      tailY.set(currentPos.y)
  ...
  }, [cursorX, cursorY, tailX, tailY, rotation, scale, isEnabled])
